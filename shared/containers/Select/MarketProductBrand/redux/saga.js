...
export function* getBrandsRequest({ limit, offset, name, status, fields }) {
  try {
    const data = yield call(getBrands, { limit, offset, name, status, fields });
...
export default function* getBrandsRoot() {
