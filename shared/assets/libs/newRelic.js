/* eslint-disable */
// Warning: When updating nr don't forget to add setErrorHandler method for ignoring specified errors.
...
window.NREUM || (NREUM = {}), __nr_require = function(t, e, n) {
  ...
  2: [function(t, e, n) {
    ...
    var i = t('handle'), a = t(33), s = t('ee'), c = t('loader'), f = t('gos'), u = window.onerror, d = !1, p = 'nr@seenError';
    if (!c.disabled) {
      var l = 0;
  ...
  4: [function(t, e, n) {
    ...
    var s = '-start', c = '-end', f = '-body', u = 'fn' + s, d = 'fn' + c, p = 'cb' + s, l = 'cb' + c, h = 'jsTime', m = 'fetch',
      v = 'addEventListener', w = window, g = w.location, y = t('loader');
    if (w[v] && y.xhrWrappable && !y.disabled) {
      var x = t(11), b = t(12), E = t(9), R = t(7), O = t(14), T = t(8), P = t(15), S = t(10), M = t('ee'), N = M.get('tracer'), C = t(23);
  ...
  5: [function(t, e, n) {
    ...
    if (window.performance && window.performance.timing && window.performance.getEntriesByType) {
      var a = t('ee'), s = t('handle'), c = t(14), f = t(13), u = t(6), d = t(23), p = 'learResourceTimings', l = 'addEventListener',
        h = 'removeEventListener', m = 'resourcetimingbufferfull', v = 'bstResource', w = 'resource', g = '-start', y = '-end',
  ...
  7: [function(t, e, n) {
    ...
    var a = t('ee').get('events'), s = t('wrap-function')(a, !0), c = t('gos'), f = XMLHttpRequest, u = 'addEventListener',
  ...
  8: [function(t, e, n) {
    ...
    e.exports = o;
    var s = window, c = 'fetch-', f = c + 'body-', u = ['arrayBuffer', 'blob', 'json', 'text', 'formData'], d = s.Request, p = s.Response,
  ...
  12: [function(t, e, n) {
    ...
    var o = t('wrap-function'), i = t('ee').get('promise'), a = t('ee').getOrSetContext, s = o(i), c = t(32), f = NREUM.o.PR;
  ...
  15: [function(t, e, n) {
    ...
    t(7);
    var f = t('ee'), u = f.get('xhr'), d = t('wrap-function')(u), p = t(23), l = NREUM.o, h = l.XHR, m = l.MO, v = l.PR, w = l.SI,
      g = 'readystatechange', y = ['onload', 'onerror', 'onabort', 'onloadstart', 'onloadend', 'onprogress', 'ontimeout'], x = [];
    e.exports = u;
  ...
  16: [function(t, e, n) {
    function r(t) {
      ...
      var n = (e.loader_config.accountID || '').toString() || null, r = (e.loader_config.agentID || '').toString() || null,
  ...
  17: [function(t, e, n) {
    ...
    if (a.xhrWrappable && !a.disabled) {
      var s = t('handle'), c = t(18), f = t(16).generateTracePayload, u = t('ee'), d = ['load', 'error', 'abort', 'timeout'], p = d.length,
        l = t('id'), h = t(24), m = t(22), v = t(19), w = t(23), g = NREUM.o.REQ, y = window.XMLHttpRequest;
  ...
  20: [function(t, e, n) {
    ...
    var i = t('handle'), a = t(32), s = t(33), c = t('ee').get('tracer'), f = t('loader'), u = t(25), d = NREUM;
    'undefined' == typeof window.newrelic && (newrelic = d);
    var p = ['setPageViewName', 'setCustomAttribute', 'setErrorHandler', 'finished', 'addToTrace', 'inlineHit', 'addRelease'], l = 'api-',
      h = l + 'ixn-';
    a(p, function(t, e) {
      d[e] = o(l, e, !0, 'api');
  ...
  21: [function(t, e, n) {
    function r(t) {
      if (NREUM.init) {
        for (var e = NREUM.init, n = t.split('.'), r = 0; r < n.length - 1; r++) if (e = e[n[r]], 'object' != typeof e) {
          return;
        }
  ...
  28: [function(t, e, n) {
    ...
    if (!('init' in NREUM && 'page_view_timing' in NREUM.init && 'enabled' in NREUM.init.page_view_timing && NREUM.init.page_view_timing.enabled === !1)) {
      var c, f, u, d, p = t('handle'), l = t('loader'), h = t(31), m = t(23), v = NREUM.o.EV;
  ...
  30: [function(t, e, n) {
    function r(t, e) {
      ...
      for (var n = i.split('.'), r = e.split('.'), a = 0; a < r.length; a++) if (r[a] !== n[a]) {
        return !1;
      }
      return !0;
    }
  ...
  loader: [function(t, e, n) {
    ...
    var a = t(26), s = t('handle'), c = t(32), f = t('ee'), u = t(30), d = t(27), p = t(21), l = t(23),
      h = p.getConfiguration('ssl') === !1 ? 'http' : 'https', m = window, v = m.document, w = 'addEventListener', g = 'attachEvent',
      y = m.XMLHttpRequest, x = y && y.prototype, b = !d(m.location);
    NREUM.o = {
      ST: setTimeout,
      SI: m.setImmediate,
      CT: clearTimeout,
...
newrelic.setErrorHandler(err => {
  return (!!(err.message.indexOf('ResizeObserver') !== -1) || !!(err.message.indexOf('Script error') !== -1));
});
