...
import reducer, { INITIAL_STATE } from '@app/pages/MarketProduct/Category/New/redux/reducer';

import { Types } from '@app/pages/MarketProduct/Category/New/redux/actions';
...
describe('MarketProduct/Category/New', () => {
  ...
  describe('reducer CREATE_MARKET_PRODUCT_CATEGORY_REQUEST', () => {
    it('receivedState should equal to expectedState', () => {
      const receivedState = reducer({}, { type: Types.CREATE_MARKET_PRODUCT_CATEGORY_REQUEST });
      const expectedState = {
  ...
  describe('reducer CREATE_MARKET_PRODUCT_CATEGORY_SUCCESS', () => {
    it('receivedState should equal to expectedState', () => {
      const receivedState = reducer({}, { type: Types.CREATE_MARKET_PRODUCT_CATEGORY_SUCCESS });
      const expectedState = {
        createMarketProductCategory: {
          isPending: false,
          error: null,
  ...
  describe('reducer CREATE_MARKET_PRODUCT_CATEGORY_FAILURE', () => {
    it('receivedState should equal to expectedState', () => {
      const receivedState = reducer({}, { type: Types.CREATE_MARKET_PRODUCT_CATEGORY_FAILURE, error: new Error('404 Not Found') });
      const expectedState = {
        createMarketProductCategory: {
          isPending: false,
          data: {},
