...
import { exportAccessGrantedPagesExcel } from './saga';
...
describe('Role/List', () => {
  describe('exportRolesExcel saga', () => {
    it('runs without errors', () => {
      ...
      const saga = exportAccessGrantedPagesExcel({ t, role });
      let next = saga.next();

      expect(next.value).toMatchObject(call(getPageAndComponentPermissionsOfRole, { roleId: role._id }));
