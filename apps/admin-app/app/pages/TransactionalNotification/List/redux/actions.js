...
export const { Types, Creators } = createActions({
  ...
  getExportNotificationListRequest: { filters: null },
  getExportNotificationListSuccess: { data: {} },
  getExportNotificationListFailure: { error: null },

  duplicateRequest: { id: null, clientLanguage: null },

  initPage: null,
  destroyPage: null,
}, { prefix: `${REDUX_KEY.TRANSACTIONAL_NOTIFICATION.LIST}_` });
