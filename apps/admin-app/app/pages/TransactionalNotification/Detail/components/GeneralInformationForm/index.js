...
import { configSelector } from '@app/pages/TransactionalNotification/Detail/redux/selectors';
  ...
  return (
    <Badge.Ribbon text={<Ribbon />}>
      <AntCard footer={false} bordered={false} title={t('GENERAL_INFO')}>
        ...
        <Row gutter={24}>
          <Col lg={24}>
            <NotifSoundTypeSelect disabled={!isFormEditable} fieldName="notificationSound" label={t('NOTIFICATION_SOUND_TYPE_SELECT')} />
          </Col>
        </Row>
        <SelectCommunicationConfig isConfigPending={isConfigPending} configData={configData} isFormEditable={isFormEditable} componentName="SENDER" />
        <SelectCommunicationConfig isConfigPending={isConfigPending} configData={configData} isFormEditable={isFormEditable} componentName="TYPE" />
        <Row gutter={24}>
          <Col md={12} xs={24}>
        ...
        <Row gutter={24}>
          <Col md={12} xs={24}>
            ...
            >
              <TimePicker disabled={!isFormEditable} format={format} placeholder={t('MAX_PUSHING_DURATION_PLACEHOLDER')} showNow={false} className="w-100" />
            </Form.Item>
          </Col>
        </Row>
        <SelectCommunicationConfig
          isConfigPending={isConfigPending}
          configData={configData}
          isFormEditable={isFormEditable}
          componentName="INTERRUPTION_LEVELS"
        />
        <SelectCategory serviceType={SERVICE_TYPES.NOTIF} disabled={!isFormEditable} />
        <SelectCallbackProperties callbackType={CALLBACK_TYPES.DATA} disabled={!isFormEditable} serviceType={SERVICE_TYPES.NOTIF} />
