...
import { MAX_DATE_RANGE_IN_DAYS, orderTypeOptions } from '../../constants';
    ...
    <Form form={form} initialValues={initialValues} layout="vertical" onFinish={onSubmit} className={classes.form}>
      <Row gutter={[8, 8]}>
        ...
        <Col xs={24} sm={6}>
          <FormItem
            name="orderTypes"
            label={t('SUCCESS.TABLE.TYPE')}
            colon={false}
          >
            <Select mode="multiple" allowClear options={orderTypeOptions} />
          </FormItem>
        </Col>
        <Col xs={24} sm={6}>
          <FormItem
            name="traceId"
            label={t('SUCCESS.TABLE.TRANSACTION_ID')}
            colon={false}
          >
            <Input />
          </FormItem>
        ...
        <Col xs={24} sm={6}>
          <FormItem
            name="orderId"
            label={t('SUCCESS.TABLE.ORDER_ID')}
            colon={false}
          >
            <Input />
          </FormItem>
