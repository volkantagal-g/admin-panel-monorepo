...
import useStyles from '@app/pages/ArtisanOrder/Detail/components/actionsMenu/modals/shopPaymentModal/styles';
            ...
            <Row>
              <Col className={classes.space} span={24}>
                <b className={classes.amount}>
                  {t('MODAL.CANCEL_LOCALS_ORDER.AMOUNT')}
                  ({t('ACTION.SUPPLIER_NET_REVENUE')}
                  {currentSupplierNetRevenue.toFixed(2)})
                </b>
