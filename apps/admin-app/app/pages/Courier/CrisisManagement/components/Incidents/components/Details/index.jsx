...
import {
  attachmentSelector,
  courierCrisisSaveSelector,
  courierCrisisUploadSelector,
...
export default function Details({ data, user, onSubmit }) {
  ...
  const currentUploadFile = useSelector(
    courierCrisisUploadSelector.getCurrentFile,
  );
  const allUploadsCompleted = useSelector(
    courierCrisisUploadSelector.getIsCompleted,
  );
  const detailsSaved = useSelector(courierCrisisSaveSelector.getIsCompleted);
  const detailsSaving = useSelector(courierCrisisSaveSelector.getIsPending);
  ...
  const formik = useFormik({
    ...
    onSubmit: async () => {
      if (filesToUpload.length) {
        ...
        dispatch(
          Creators.uploadCourierCrisisFilesStart({
  ...
  const saveCrisisDetails = useCallback(
    files => {
      ...
      dispatch(Creators.saveCourierCrisisRequest({ details }));
    },
  ...
  useEffect(() => {
    if (detailsSaved) {
      handleCancel();
      dispatch(Creators.saveCourierCrisisReset());
