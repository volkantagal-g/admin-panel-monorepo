...
import { crisisIncidentDetails } from '@shared/api/courierCrisis/index.mock.data';
...
describe('Courier Crisis Management: Incident Details', () => {
  ...
  describe('Edit Entry', () => {
    ...
    it('form is/can be populated properly', async () => {
      ...
      mockApiPerTestCase({
        url: `/courierCrisisManagement/updateCard/${data._id}`,
        handler: () => {},
      });
