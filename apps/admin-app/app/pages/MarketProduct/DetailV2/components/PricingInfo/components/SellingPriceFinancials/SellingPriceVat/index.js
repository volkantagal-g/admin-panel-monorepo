...
export const SellingPriceVat = memo(function SellingPriceVat({ activationErrorsForSellingPrice }) {
  ...
  return (
    <Form form={form} id={FORM_IDS.SELLING_PRICE_VAT} onFinish={handleSubmit}>
      <Row>
        <Col xs={24} md={8}>
          <Select
            data-testid="vat"
      ...
      <Can permKey={permKey.PAGE_MARKET_PRODUCT_DETAIL_COMPONENT_FIELD_EDIT}>
        <EditSaveCancelButtons
          ...
          form={FORM_IDS.SELLING_PRICE_VAT}
          htmlType="submit"
