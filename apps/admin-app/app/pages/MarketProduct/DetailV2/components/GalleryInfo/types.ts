import { PRODUCT_IMAGE_VALID_RATIOS, WIDE_IMAGE_VALID_RATIOS, SUPPORTED_IMAGE_FORMATS } from './constants';

export type SupportedImageFormat = typeof SUPPORTED_IMAGE_FORMATS[number];
export type ValidImageRatio = typeof PRODUCT_IMAGE_VALID_RATIOS[number] | typeof WIDE_IMAGE_VALID_RATIOS[number];
