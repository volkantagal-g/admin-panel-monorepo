...
const FavoriteRentEndCityDetail = () => {
  ...
  return (
    <CollapsePanel header={t('GETIR_DRIVE_FAVORITE_RENT_END_CITY_DETAIL')} activeKey={activeKey}>
      <ActiveParamButtons
        activeKey={activeKey}
      ...
      <Row justify="space-between">
        <Col span={11}>
          ...
          <MultipleSelect
            activeKey={activeKey}
            value={data.cities}
            label={t('GETIR_DRIVE_FAVORITE_RENT_END_CITY')}
...
export default FavoriteRentEndCityDetail;
