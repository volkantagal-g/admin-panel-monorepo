...
const subSectionName = 'rentDistanceTravelled';
const activeKey = `${clientListSections.getirDriveServiceDetail}.${subSectionName}`;

const RentDistanceTravelledDetail = () => {
  ...
  const minCountKey = 'minAverageDistanceTravelled';
  const maxCountKey = 'maxAverageDistanceTravelled';

  return (
    <CollapsePanel header={t('GETIR_DRIVE_RENT_DISTANCE_TRAVELLED_DETAIL')} activeKey={activeKey}>
      <ActiveParamButtons
        activeKey={activeKey}
      ...
      <Row justify="space-between">
        <Col span={11}>
          ...
          <MinMaxInput
            ...
            label={t('AVERAGE_DISTANCE_TRAVELLED_KM')}
          />
        </Col>
        <Col span={11}>
...
export default RentDistanceTravelledDetail;
