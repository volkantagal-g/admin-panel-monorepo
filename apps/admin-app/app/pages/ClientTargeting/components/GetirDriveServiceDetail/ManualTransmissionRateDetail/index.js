...
const subSectionName = 'manualTransmissionRate';
const activeKey = `${clientListSections.getirDriveServiceDetail}.${subSectionName}`;

const ManualTransmissionRateDetail = () => {
  ...
  const minCountKey = 'minManualTransmissionRate';
  const maxCountKey = 'maxManualTransmissionRate';

  return (
    <CollapsePanel header={t('GETIR_DRIVE_MANUAL_TRANSMISSION_RATE_DETAIL')} activeKey={activeKey}>
      <ActiveParamButtons
        activeKey={activeKey}
      ...
      <Row justify="space-between">
        <Col span={11}>
          ...
          <MinMaxInput
            ...
            label={t('GETIR_DRIVE_MANUAL_TRANSMISSION_RATE')}
          />
        </Col>
        <Col span={11}>
...
export default ManualTransmissionRateDetail;
