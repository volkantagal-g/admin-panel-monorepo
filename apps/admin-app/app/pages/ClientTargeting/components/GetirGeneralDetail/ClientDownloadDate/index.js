...
const ClientDownloadDate = () => {
  ...
  return (
    <CollapsePanel header={t('CLIENT_DOWNLOAD_DATE')} activeKey={activeKey}>
...
export default ClientDownloadDate;
