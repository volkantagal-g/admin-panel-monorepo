...
const Getir30DeliveryDurationDetail = () => {
  ...
  return (
    <CollapsePanel header={t('G30_DELIVERY_DURATION_DETAIL')} activeKey={activeKey}>
...
export default Getir30DeliveryDurationDetail;
