...
import { FILTER_FORM } from '@app/pages/CommunicationServiceCredentials/List/components/Filter/config';
import { Creators } from '@app/pages/CommunicationServiceCredentials/List/redux/actions';
import { manipulateValuesBeforeSubmit } from '@app/pages/CommunicationServiceCredentials/List/components/Filter/utils';
...
const CommunicationServiceCredentialsFilter = ({ serviceType, setServiceType }) => {
...
export default memo(CommunicationServiceCredentialsFilter);
