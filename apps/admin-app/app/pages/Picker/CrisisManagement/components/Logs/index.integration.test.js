...
import { crisisLogsList } from '@shared/api/pickerCrisis/index.mock.data';
...
describe.skip('Picker Crisis Management: Log', () => {
  let origWindowOpen;
  beforeAll(() => {
  ...
  it('is present in the page', async () => {
    await renderComponent({ ui: <CrisisLogs pickerId="587c9e24a1a56d0014072d82" /> });
    expect(screen.getByTestId('picker-crisis-log')).toBeInTheDocument();
  });
