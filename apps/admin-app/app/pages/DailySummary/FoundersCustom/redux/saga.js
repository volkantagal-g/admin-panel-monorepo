...
function* watchGetGlobalDailySummaryData() {
  yield takeLatest(Types.GET_GLOBAL_DAILY_SUMMARY_DATA_REQUEST, getGlobalDailySummaryDataRequest);
}

export default function* dailySummaryFoundersCustomPageRootSaga() {
  while (yield take(Types.INIT_PAGE)) {
    const backgroundTasks = yield all([
      fork(watchGetGlobalDailySummaryData),
    ]);
