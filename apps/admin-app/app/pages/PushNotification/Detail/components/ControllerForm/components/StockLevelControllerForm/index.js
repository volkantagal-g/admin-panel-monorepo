...
const StockLevelControllerForm = ({ form, controlFormName, isFormEditable }) => {
    ...
    <Card size="small" title={t('STOCK_LEVEL_CONTROLLER')}>
      <Row gutter={24}>
        <AntSelectWithCsvImport
          disabled={isPendingMarketProduct || !isFormEditable}
      ...
      <Row gutter={24}>
        <Col xs={24} sm={12} lg={12}>
          ...
          >
            <Select options={convertConstantValuesToSelectOptions(notificationInclusionType)} disabled={!isFormEditable} />
          </Form.Item>
        </Col>
      </Row>
