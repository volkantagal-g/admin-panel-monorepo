...
import { fileUploadSelector } from '@app/pages/PushNotification/New/redux/selectors';
import { notificationTemplateTypes } from '@app/pages/PushNotification/constantValues';

const ListInformationForm = ({ form }) => {
    ...
    <AntCard footer={false} bordered={false} title={t('LIST_INFORMATION')}>
      <Row gutter={24}>
        <DraftImporter
          ...
          form={form}
          templateTypes={notificationTemplateTypes}
