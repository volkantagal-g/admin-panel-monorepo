...
const feedbackSourceTestId = '5bc48e961f56680e17932098';
const initialUrl = `/dts/setting/feedbacksource/${feedbackSourceTestId}`;

describe('In Dts Feedback Source Detail Page:', () => {
  describe('For page features', () => {
    it('should render without an error', async () => {
      await renderPage({
        pagePermKey: permKey.PAGE_DTS_FEEDBACK_SOURCE_SETTING_DETAIL,
        pageUrl: initialUrl,
    ...
    it('should have correct page content', async () => {
      expect(screen.getByText('DTS Feedback Setting Detail')).toBeInTheDocument();
