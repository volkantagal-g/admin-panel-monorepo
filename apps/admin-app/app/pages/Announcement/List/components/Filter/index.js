...
import { FILTER_FORM } from '@app/pages/Announcement/List/components/Filter/config';
import { Creators } from '@app/pages/Announcement/List/redux/actions';
import { initialValues, manipulateValuesAfterSubmit } from '@app/pages/Announcement/List/components/Filter/utils';
...
import { INITIAL_STATE } from '@app/pages/Announcement/List/redux/reducer';
...
export default memo(AnnouncementFilter);
