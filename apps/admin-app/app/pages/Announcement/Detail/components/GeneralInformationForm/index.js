      ...
      <AntCard footer={false} bordered={false} title={t('GENERAL_INFO')}>
        <Row gutter={24}>
          <Col lg={12}>
            ...
            >
              <Select options={convertConstantValuesToSelectOptions(statusTypeOptions)} disabled={!isFormEditable} />
            </Form.Item>
          </Col>
        </Row>
        ...
        <Row gutter={24}>
          <Col md={12} xs={24}>
            <TargetDomainSelect fieldName="domainType" rules={rules.onlyRequired} disabled={!isFormEditable} />
          </Col>

          <Col md={12} xs={24}>
            <Form.Item noStyle hasFeedback name="accessibilityLabel" className="d-inline">
