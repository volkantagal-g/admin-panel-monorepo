...
import ImageCarousel from '@app/pages/Banner/New/components/ContentInformationForm/components/ImageCarousel';
import { INACTIVE_ACTIONS, COMPONENT_TYPE } from '@app/pages/Banner/constants';
...
const ContentInformationForm = ({ form }) => {
  ...
  return (
    <AntCard bordered={false} title={<CardHeader t={t} />}>
      <Form.Item
        noStyle
                        ...
                        {(componentType === COMPONENT_TYPE.MAXI || componentType === COMPONENT_TYPE.DYNAMIC_CARD) && (
                          <Row className="mt-2">
                            <Col lg={24}>
                              ...
                              >
                                <Input placeholder={t('TITLE')} maxLength={30} />
                              </Form.Item>
                            </Col>
                          </Row>
                        )}
                          ...
                          <>
                            <Row className="mt-2">
                              <Col lg={24}>
                                ...
                                >
                                  <Input placeholder={t('DESCRIPTION')} maxLength={50} />
                                </Form.Item>
                              </Col>
                            </Row>
                            <Row className="mt-2">
