...
export const { Types, Creators } = createActions(
  {
    getCampaignDetailRequest: { campaignId: undefined },
    getCampaignDetailSuccess: { data: {} },
    getCampaignDetailFailure: { error: null },
    getPromoUsageDetailRequest: { campaignId: undefined },
    getPromoUsageDetailSuccess: { data: {} },
    getPromoUsageDetailFailure: { error: null },
    updateCampaignRequest: { data: {}, campaignId: undefined },
    updateCampaignSuccess: { campaigns: [] },
    updateCampaignFailure: { error: null },
    getBrandsRequest: {},
    ...
    updateCampaignStatusRequest: { data: {}, campaignId: undefined },
    updateCampaignStatusSuccess: { campaigns: [] },
    updateCampaignStatusFailure: { error: null },
