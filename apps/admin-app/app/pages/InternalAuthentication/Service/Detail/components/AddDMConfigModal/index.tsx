...
type AddDMConfigModalProps = {
  onClose: () => void;
};

const AddDMConfigModal = ({ onClose }: AddDMConfigModalProps) => {
  ...
  const formik = useFormik({
    ...
    onSubmit: values => {
      ...
      dispatch(Creators.updateSlackConfigurationsRequest({
        teamId,
        serviceId,
        workspaceDMConfigPairs: [...workspaceDMConfigPairs, values],
...
export default AddDMConfigModal;
