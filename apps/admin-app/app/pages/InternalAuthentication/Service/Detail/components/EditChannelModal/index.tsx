...
const EditChannelModal = ({ index, onClose }: EditChannelModalProps) => {
  ...
  const formik = useFormik({
    initialValues: getInitialValues(slackConfigurations?.workspaceChannelNamePairs?.[index]),
    ...
    onSubmit: values => {
      ...
      workspaceChannelNamePairs[index] = values;
