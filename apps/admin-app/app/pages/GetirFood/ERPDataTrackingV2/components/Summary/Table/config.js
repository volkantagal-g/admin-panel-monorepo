...
export const tableColumns = (t, linkClassname, handleFailDetailClick, handleSuccessfulDetailClick) => [
  {
  ...
  },
  {
    ...
    render: (value, record) => (value > 0 ?
      <Button className={linkClassname} onClick={() => handleSuccessfulDetailClick(record.orderType?.value)} type="link">{value}</Button> :
      value),
  },
  {
