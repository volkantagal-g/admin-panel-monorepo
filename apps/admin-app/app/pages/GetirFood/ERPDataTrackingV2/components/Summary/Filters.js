...
import { ERPDataTrackingSummaryExcelExportSelector } from '../../redux/selectors';
...
const Filters = ({ onChangeFilters }) => {
  ...
  const isExcelPending = useSelector(ERPDataTrackingSummaryExcelExportSelector.getIsPending);
  ...
  const handleExcelExport = () => {
    dispatch(
      Creators.getERPDataTrackingSummaryExcelExportRequest({
  ...
  return (
    <Form
      initialValues={SUMMARY_INITIAL_FILTERS}
