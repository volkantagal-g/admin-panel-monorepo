...
import { getExternalTransactionReport } from '@app/pages/GetirFood/RestaurantExternalTransaction/redux/selectors';
import { getLocalDateFormat } from '@shared/utils/localization';
import { convertConstantValuesToSelectOptions } from '@shared/utils/common';

import { Creators } from '../../redux/actions';
import { MAX_DATE_RANGE_IN_DAYS, INITIAL_VALUES, MANUAL_TYPES_VALUES } from './constants';
...
const SingleTransaction = () => {
  ...
  const [dates, setDates] = useState(INITIAL_VALUES.dateRange);
  ...
  return (
    <AntCard title={t('TRANSACTION_REPORT.TITLE')}>
      <Form onFinish={handleSubmit} initialValues={INITIAL_VALUES} requiredMark={false}>
        <Row gutter={[32]}>
          ...
          <Col xs={24} sm={12} md={6}>
            <Form.Item name="shopId">
              <SelectRestaurant allowIdSearch />
            </Form.Item>
          </Col>
          <Col xs={24} sm={12} md={6}>
            <Form.Item>
