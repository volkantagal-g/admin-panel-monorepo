...
import { bulkExternalTransactionExcel } from '@app/pages/GetirFood/RestaurantExternalTransaction/redux/selectors';

import useStyles from './styles';
import { EXCEL_TEMPLATE_URL } from './constants';

import {
  DEFERRED_PAYMENT_DATE_OPTIONS,
  DEFERRED_PAYMENT_DATE_TYPES,
} from '@app/pages/ShopExternalTransaction/components/BulkTransaction/components/TransactionModal/constants';
...
const TransactionModal = ({
  ...
  const openConfirmModal = ({ fileName, amount, restaurantCount }) => {
