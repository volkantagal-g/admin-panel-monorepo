...
import { Creators } from '@app/pages/Algorithm/Config/List/redux/actions';
import {
  algorithmConfigListSelector,
  bulkEditCsv,
  exportCsvSelector,
} from '@app/pages/Algorithm/Config/List/redux/selectors';
...
const AlgorithmConfigBulkUpload = ({ isDomain }) => {
  ...
  const handleConfirmSubmit = ({ base64File }) => {
    dispatch(Creators.bulkEditCsvRequest({ namespace: selectedNamespace, file: { base64File: base64File.split(',')[1] }, isDomain }));
  };
