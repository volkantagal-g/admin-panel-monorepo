...
import { POSITIVE_BUTTON_INACTIVE_ACTION } from '@app/pages/NotificationCenter/New/components/ContentInformationForm/constants';
import { convertPhoneLanguageOptions } from '@app/pages/NotificationCenter/utils';
import { fileUploadSelector } from '@app/pages/NotificationCenter/New/redux/selectors';
                ...
                <Card title={<NotificationCenterCardHeader title={t('ANNOUNCEMENT')} lang={lang} />} bordered>
                  ...
                  >
                    <Switch
                      ...
                      onChange={value => {
                        // Reset button text and action value when switch off
                        if (!value) {
                          form.setFields([{ name: [...CONTENT_DETAIL_FIELD_NAME, lang, 'button', 'text'], value: '' }]);
                          form.setFields([{ name: [...CONTENT_DETAIL_FIELD_NAME, lang, 'button', 'action'], value: {} }]);
                        }
                      }}
                    />
                  </Form.Item>
