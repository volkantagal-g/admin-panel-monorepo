...
const traPrefix = 'stockOrderVolumeAuto:DATATABLE.COLUMNS';
...
export const generateColumns = (t, wrappedProducts, setWrappedProducts) => {
  ...
  const columns = [
    ...
    {
      title: t(`${traPrefix}.MAX_STOCK_DAY`),
    ...
    {
      title: t(`${traPrefix}.STOCK_ORDER_DAY`),
    ...
    {
      title: t(`${traPrefix}.STOCK_TRANSFER_DAY`),
    ...
    {
      title: t(`${traPrefix}.DEMAND_MULTIPLIER`),
