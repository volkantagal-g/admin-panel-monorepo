...
const Getir10DeliveryDurationDetail = () => {
  ...
  return (
    <CollapsePanel header={t('G10_DELIVERY_DURATION_DETAIL')} activeKey={activeKey}>
...
export default Getir10DeliveryDurationDetail;
