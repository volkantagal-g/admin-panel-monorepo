...
const OrderFrequencyDetail = () => {
  ...
  return (
    <CollapsePanel header={t('GWMP_ORDER_FREQUENCY_DETAIL')} activeKey={activeKey}>
...
export default OrderFrequencyDetail;
