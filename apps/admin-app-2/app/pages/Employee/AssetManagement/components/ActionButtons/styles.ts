...
export default createUseStyles(theme => ({
  ...
  profilePictureWrapper: { width: '150px', display: 'grid', placeItems: 'Center' },
  ...
  effectiveDateModalDescription: {
    '& .ant-descriptions-item-content': { paddingBottom: 8 },
    '& .ant-form-item': { marginBottom: 12 },
  },
  warningContainer: { borderRadius: '8px' },
}));
