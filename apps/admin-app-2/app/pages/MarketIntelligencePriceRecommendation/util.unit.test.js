import {
  ...
  priceColor,
  isValidate,
} from '@app/pages/MarketIntelligencePriceRecommendation/utils/common';
...
} from '@app/pages/MarketIntelligencePriceRecommendation/utils/tableColorFinder';

describe('Price Recommendation utils #tableColorFinder', () => {
...
describe('Price Recommendation utils #common', () => {
  describe('#isFloat', () => {
  ...
  describe('#priceColor', () => {
    it('should return green', () => {
      expect(priceColor(200)).toEqual('green');
    });
    it('should return green', () => {
      expect(priceColor(300)).toEqual('green');
    });
    it('should return green', () => {
      expect(priceColor(600)).toEqual('green');
    });
    it('should return green', () => {
      expect(priceColor(15)).toEqual('green');
    });
    it('should return red', () => {
      expect(priceColor(-200)).toEqual('red');
    });
  });
  describe('#isValidate', () => {
    it('should return true', () => {
      expect(isValidate(200)).toEqual(true);
    });
    it('should return false', () => {
      expect(isValidate('')).toEqual(false);
    });
    it('should return false', () => {
      expect(isValidate(null)).toEqual(false);
    });
    it('should return true', () => {
      expect(isValidate(15)).toEqual(true);
    });
    it('should return true', () => {
      expect(isValidate(0)).toEqual(true);
    });
  });
});

describe('Price Recommendation utils #changePrice', () => {
  describe('#isFloat', () => {
    it('should return false', () => {
      expect(isFloat(200)).toEqual(false);
    });
