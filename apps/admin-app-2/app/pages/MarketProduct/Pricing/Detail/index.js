...
const MarketProductPricingDetailPage = () => {
  usePageViewAnalytics({ name: ROUTE.MARKET_PRODUCT_PRICING_DETAIL.name, squad: ROUTE.MARKET_PRODUCT_PRICING_DETAIL.squad });
  ...
  useEffect(() => {
    ...
    dispatch(Creators.getMarketProductPriceDetailRequest({ id }));
...
export default compose(withReducer, withSaga)(MarketProductPricingDetailPage);
