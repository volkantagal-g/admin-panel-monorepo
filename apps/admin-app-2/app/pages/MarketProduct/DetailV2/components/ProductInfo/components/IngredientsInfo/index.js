...
const IngredientsInfo = () => {
  ...
  return (
    <Space title={t('INGREDIENTS_INFO.TITLE')}>
      <Form
        form={form}
        id={PRODUCT_DETAIL_COMPONENT_ID.INGREDIENTS_INFO}
        onFinish={handleSubmit}
        layout="vertical"
      >
        <MultiLanguageTextEditor
          originalValue={get(initialValues, 'ingredients', {})}
        ...
        <EditSaveCancelButtons
          ...
          form={PRODUCT_DETAIL_COMPONENT_ID.INGREDIENTS_INFO}
          htmlType="submit"
